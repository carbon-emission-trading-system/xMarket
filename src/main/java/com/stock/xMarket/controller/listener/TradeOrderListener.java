...
/**
 * The listener interface for receiving tradeOrder events.
 * The class that is interested in processing a tradeOrder
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addTradeOrderListener<code> method. When
 * the tradeOrder event occurs, that object's appropriate
 * method is invoked.
 *
 * @see TradeOrderEvent
 */
