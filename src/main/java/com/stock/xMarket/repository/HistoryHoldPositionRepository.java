...
public interface HistoryHoldPositionRepository extends JpaRepository<HistoryHoldPosition,Integer> {
	...
	@Query(value="select new com.stock.xMarket.VO.HistoryHoldPositionVO(h.stockId,h.stockName,h.buildPositionDate,h.clearPositionDate,h.stockHoldDay,h.totalProfitAndLoss,h.profitAndLossRatio) from HistoryHoldPosition h where h.userId=:userId")
