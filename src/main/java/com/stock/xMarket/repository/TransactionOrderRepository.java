...
public interface TransactionOrderRepository extends JpaRepository<TransactionOrder,Integer> {
	...
	@Query(value="select new org.boot.wjq.VO.TransactionOrderVO(t.date,t.time,t.stockId,t.stockName,t.point,t.tradePrice,t.exchangeAmount,(t.tradePrice*t.exchangeAmount) as totalExchangeMoney,"
